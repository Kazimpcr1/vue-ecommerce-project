<template>
    <div style="margin: 0 auto; max-width: 900px; padding: 50px">
        <div id="invoice_slip" class="woocommerce-order">
            <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received">Thank you.
                Your order has been received.</p>
            <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details" style="">
                ...
                <li class="woocommerce-order-overview__total total">
                    Total: <strong><span class="woocommerce-Price-amount amount"><span
                                class="woocommerce-Price-currencySymbol">£</span>229.00</span></strong>
                </li>
            ...
            <section class="woocommerce-order-details">
                    ...
                    <tbody>
                        <tr class="woocommerce-table__line-item order_item">
                            <td class="woocommerce-table__product-name product-name">
                                <a href="https://demo.woothemes.com/storefront/product/standard-colander/">Standard
                                    Colander</a> <strong class="product-quantity">×
                                    1</strong>
                            </td>
                            <td class="woocommerce-table__product-total product-total">
                                <span class="woocommerce-Price-amount amount"><span
                                        class="woocommerce-Price-currencySymbol">£</span>19.99</span>
                            </td>
                        </tr>
                        <tr class="woocommerce-table__line-item order_item">
                            <td class="woocommerce-table__product-name product-name">
                                <a
                                    href="https://demo.woothemes.com/storefront/product/scubapro-10-litre-232-bar-cylinder-single-valve/">Scubapro
                                    10 litre 232 bar cylinder – single valve</a> <strong class="product-quantity">×
                                    1</strong>
                            </td>
                            <td class="woocommerce-table__product-total product-total">
                                <span class="woocommerce-Price-amount amount"><span
                                        class="woocommerce-Price-currencySymbol">£</span>229.00</span>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td><span class="woocommerce-Price-amount amount"><span
                                        class="woocommerce-Price-currencySymbol">£</span>248.99</span>
                            </td>
                        </tr>
                        <tr>
                ...
                <section class="woocommerce-customer-details">
                    ...
                    <address>
                        Alphacoder Technologies
                        <br>Muree Road,
                        <br>Waris Khan Metro Station
                        <br>MCB Bank Rawalpindi
                    </address>
        ...
        <div class="text-center  py-4">
            <button class="btn btn-secondary p-2" @click="generatePDF">Download</button>
        </div>
    </div>
...
export default {
    methods: {
        generatePDF() {
            // Select the HTML element that you want to download as a PDF
            const element = document.getElementById('invoice_slip')

            // Use jsPDF's .fromHTML function to generate the PDF
            const pdf = new jsPDF()
...
.form-row .button[type="%23fff"]:hover,
.form-row .button[type="%23fff"]:focus,
.form-row .button[type="%23fff"]:active {
    background-color: var(--color-primary-darker);
    border-color: var(--color-primary-darker);
}
